...
function setUpGUI()
{
    ...
    registerVariable("ruinChance", "Ruin Chance", "The average percent chance the domme will ruin an orgasm. NOTE: This is the percentage an orgasm" +
        "will be ruined after the domme has decided you will cum. Basically, to have an orgasm ruined, first the domme would have to decide to let you cum. Furthermore, " +
    ...
    if (getVar("!setupvariables", null) == null) 
    {
        setVar("!setupvariables", true);
    }
    registerVariable("!setupvariables", "Setup Variables", "Only change if needed. If true the domme will rerun the introduction script");
    addCheckBox("Options", "!setupvariables");


    //Sub settings   ----------------------------------------------------------------------------------------------------------------------------------------------


    if (getVar("sublikingedge", null) == null) 
    {
        setVar("sublikingedge", 5);
    }
    registerVariable("sublikingedge", "Edging", "How much do you like edging. Enter a number between 1 and 10.");
    addSpinner("Sub", "sublikingedge", 1, 10);

    if (getVar("sublikinganal", null) == null) 
    {
        setVar("sublikinganal", 5);
    }
    registerVariable("sublikinganal", "Analplay", "How much do you like analplay. Enter a number between 1 and 10.");
    addSpinner("Sub", "sublikinganal", 1, 10);

    if (getVar("subatecum", null) == null) 
    {
        setVar("subatecum", false);
    }
    registerVariable("subatecum", "Did eat cum", "Did you ever ate cum?");
    addCheckBox("Sub", "subatecum");

    if (getVar("sublikingcei", null) == null) 
    {
        setVar("sublikingcei", 5);
    }
    ...
    if (getVar("dommehard", null) == null) 
    {
        setVar("dommehard", false);
    }
    registerVariable("dommehard", "Hardcore-Mode", "Is your domme allowed to force you to do something you don't like?");
    addCheckBox("Domme", "dommehard");

    if (getVar("dommelikingedge", null) == null) 
    {
        setVar("dommelikingedge", 5);
    }
    registerVariable("dommelikingedge", "Edging", "How much should your domme likes to edge you. Enter a number between 1 and 10.");
    addSpinner("Domme", "dommelikingedge", 1, 10);

    if (getVar("dommelikinganal", null) == null) 
    {
        setVar("dommelikinganal", 5);
    }
    registerVariable("dommelikinganal", "Analplay", "How much should your domme likes analplay. Enter a number between 1 and 10.");
    addSpinner("Domme", "dommelikinganal", 1, 10);

    if (getVar("dommelikingcei", null) == null) 
    {
        setVar("dommelikingcei", 5);
    }
    registerVariable("dommelikingcei", "Cum-Eating", "How much should your domme likes to let you eat your own cum. Enter a number between 1 and 10.");
    addSpinner("Domme", "dommelikingcei", 1, 10);

    //Toys Settings -------------------------------------------------------------------------------------------------------------------------------------------------

    if (getVar("toyfleshlight", null) == null) 
    {
        setVar("toyfleshlight", false);
    }
    registerVariable("toyfleshlight", "Fleshlight", "Do you have a fleshlight and do you want to use it during sessions?");
    addCheckBox("Toys", "toyfleshlight");

    if (getVar("toyplug", null) == null) 
    {
        setVar("toyplug", false);
    }
    registerVariable("toyplug", "Analplug", "Do you have an analplug and do you want to use it during sessions?");
    addCheckBox("Toys", "toyplug");

    if (getVar("toyshoelace", null) == null) 
    {
        setVar("toyshoelace", false);
    }
    registerVariable("toyshoelace", "Shoelace", "Do you have shoelaces and do you want to use them during sessions?");
    addCheckBox("Toys", "toyshoelace");
