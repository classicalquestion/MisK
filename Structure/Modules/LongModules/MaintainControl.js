...
startEdging();
CMessage("Stop stroking", null, false);
CMessage("Let the edge fade away");
...
CMessage("Your %Cock% is going to reach a point");
...
startEdging();
CMessage("Stop stroking", null, false);
CMessage("Let the edge fade.");
CMessage("Pain");
CMessage("Pleasure");
CMessage("Relief");
CMessage("Agony");
CMessage("Those words don't mean anything to your %cock% %PetName%");
...
CMessage("Just to make me happy %Grin%");
